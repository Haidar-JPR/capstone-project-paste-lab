...
Color kGreenColor = const Color(0XFF448766).withOpacity(0.7);
Color kRedColor = const Color(0XFFC06161).withOpacity(0.7);
Color kLightGreenColor = const Color(0XFF40EE52);
